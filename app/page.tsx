...
import {
  ...
  LoaderCircle, Menu, Radio, Search, Server, ShieldCheck, Sparkles, TerminalSquare, Upload, X, Zap,
} from 'lucide-react';
      ...
      <div className="flex min-h-[calc(100vh-56px)]">
        <aside className="hidden w-52 shrink-0 border-r border-[#26312b] bg-[#090d0f] p-3 lg:flex lg:flex-col">
          ...
          <nav className="space-y-1">
            <a className="flex h-9 items-center gap-2.5 border-l-2 border-[#d6ff00] bg-[#171d0f] px-3 text-xs text-white" href="#incidents"><AlertTriangle size={14} className="text-[#d6ff00]" />Incidents<span className="ml-auto bg-[#d6ff00] px-1.5 py-0.5 font-mono text-[9px] font-bold text-black">{incidents.length}</span></a>
        ...
        <div className="min-w-0 flex-1">
          <section className="border-b border-[#26312b] bg-[#0b1012] px-4 py-5 lg:px-6">
            <div className="mx-auto flex max-w-[1500px] flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div>
                <div className="mb-1 flex items-center gap-2 font-mono text-[9px] tracking-[0.16em] text-[#65736b]"><span>OPS</span><ChevronRight size={10} /><span>INCIDENTS</span><ChevronRight size={10} /><span className="text-[#d6ff00]">LIVE ANALYSIS</span></div>
